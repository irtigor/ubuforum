...
<body>';
	...
	echo '
	<div id="topo2" class="tborder" ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' style="width: 100%;"' : '', '>
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td class="catbg" id="topo" height="32">';
            echo'
                    <img src="', $settings['images_url'], '/ubuntu_logo.png" style="padding-top:10px;" /> <br />';
	if (empty($settings['header_logo_url']))
		echo '
				    <span style="font-family: Verdana, sans-serif; font-size: 140%; padding-left: 10px;">', $context['forum_name'], '</span>';
	else
		echo '
	...
	echo '
                ...
                <td id="menu" align="right" width="50%">
                    <ul>
                        <li><a href="" title="Ubuntu">Ubuntu</a></li>
                        <li><a href="" title="Ubuntu - Br">Ubuntu - Br</a></li>
                        <li><a href="" title="Ubuntu - Pt">Ubuntu - Pt</a></li>
                        <li><a href="" title="Forum">F&oacute;rum</a></li>
                        <li><a href="" title="Planeta">Planeta</a></li>
                    </ul>
                </td>
			</tr>
		</table>';
	...
	echo '<td class="titlebg2" height="32" align="right">';
